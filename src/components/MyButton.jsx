...
export const MyButton = ({text}) => {
  ...
  return (
    <button className='relative inline-flex h-10 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-gray-50'>
        ...
        <span className='inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-[#2B2B2B] px-5 py-1 text-sm font-medium text-gray-50 backdrop-blur-3xl'
          onClick={()=>navigate('/')}
        >
          {text}
        </span>
